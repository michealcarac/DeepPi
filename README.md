...
**After this point, you can move all of your models over to your Raspberry Pi, and install [TensorFlow-Lite](https://www.tensorflow.org/lite/guide/python) on your Raspberry Pi. The python scripts will be for use on the Raspberry Pi Zero W as if it is fully constructed with the component list above.**
